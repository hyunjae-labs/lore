...
### Fixed
- Server now reports version from `package.json` instead of hardcoded value.

## [0.3.2] - 2026-05-13

### Changed
- Expanded Node.js engine requirement from `>=20 <24` to `>=20` to support Node 24, 25, and 26.
