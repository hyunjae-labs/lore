...
Always use available filters:

```
project: "-Users-hyunjaelim-projects-SEAIS"  # Scope to project
limit: 5-10                                    # Per query, not total
before: "2026-03-01"                           # Time-bound
after: "2026-02-15"                            # Time-bound
```

- When user mentions a project → set `project`
...
5. Scope: Set project/before/after/limit parameters
